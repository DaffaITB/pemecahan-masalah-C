...
int main() {
// Script pembuka
	printf("Di siang hari yang terik, kamu pergi untuk mencari padi dan kapas.\n\n"
			"...\n\n"
			"Di tengah jalan, kamu bertemu dengan doremonangis beserta Pak Robin.\n"
			"Pak Robin datang ke kamu, dia memperlihatkan alat penemuannya yang\n"
			"dinamakan ROUND-ROBIN. Akan tetapi, Pak Robin belum yakin karena alat\n"
			"ini butuh tahap pengujian. Bisakah kamu bantu Pak Robin mencoba alat ini?\n\n");
	system("pause");
	printf("\n\n\nROUND-ROBIN\n\n");
...
// Script penutup
	printf("*BIP* *BIP* selesai \\^o^/\n"
		   "ROUND-ROBIN teruji dengan baik.\n\n"
		   "Pak Robin berterimakasih atas bantuanmu!\n"
		   "'semoga kamu menemukan padi dan kapas\n"
		   "di negeri ini ya!', doa Pak Robin\n\n"
		   "...\n\n"
		   "Kamu pergi dan meneruskan perjuanganmu.\n"
		   "-TAMAT-\n\n");
